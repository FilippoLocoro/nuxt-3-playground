<template>
    <div class="page">
        ...
        <div class="bg-secondary py-10">
            <ul class="container mx-auto grid grid-cols-1 gap-4 mx-auto md:grid-cols-2 lg:grid-cols-3 px-6">
                <li v-for="activity in activities" :key="activity.id" class="overflow-hidden rounded-2xl">
                    <NuxtLinkLocale
                        ...
                        <div
                            class="absolute top-0 left-0 z-10 w-full h-full flex gap-4 flex-col items-center justify-center text-white text-lg text-center px-6 font-bold md:text-xl">
                            {{
            activity.title }}
